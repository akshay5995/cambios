...
const command_1 = __nccwpck_require__(7922);
...
const colorConvert = __nccwpck_require__(8011);
...
const escapeStringRegexp = __nccwpck_require__(639);
const ansiStyles = __nccwpck_require__(6117);
const stdoutColor = (__nccwpck_require__(3441).stdout);

const template = __nccwpck_require__(7153);
...
/* MIT license */
var cssKeywords = __nccwpck_require__(4202);
...
var conversions = __nccwpck_require__(2446);
var route = __nccwpck_require__(9311);
...
var isArrayish = __nccwpck_require__(6256);
...
var implementation = __nccwpck_require__(1490);
...
var bind = __nccwpck_require__(3988);
...
const gitHosts = __nccwpck_require__(6897)
...
const gitHosts = __nccwpck_require__(6897)
const GitHost = module.exports = __nccwpck_require__(9785)
...
var has = __nccwpck_require__(5663);
...
var data = __nccwpck_require__(1298);
...
var isValidSemver = __nccwpck_require__(6825)
var cleanSemver = __nccwpck_require__(993)
var validateLicense = __nccwpck_require__(8367)
var hostedGitInfo = __nccwpck_require__(3790)
var isBuiltinModule = __nccwpck_require__(3118)
var depTypes = ['dependencies', 'devDependencies', 'optionalDependencies']
var extractDescription = __nccwpck_require__(4515)
var url = __nccwpck_require__(7310)
var typos = __nccwpck_require__(1088)
...
var util = __nccwpck_require__(3837)
var messages = __nccwpck_require__(697)
...
var fixer = __nccwpck_require__(1913)
normalize.fixer = fixer

var makeWarning = __nccwpck_require__(2415)
...
const errorEx = __nccwpck_require__(8896);
const fallback = __nccwpck_require__(2108);
const {default: LinesAndColumns} = __nccwpck_require__(2480);
const {codeFrameColumns} = __nccwpck_require__(3096);
...
const { re, t } = __nccwpck_require__(410)
...
*/
var parse = __nccwpck_require__(6627)
var spdxLicenseIds = __nccwpck_require__(8134)
...
var scan = __nccwpck_require__(5253)
var parse = __nccwpck_require__(4452)
...
var licenses = []
  .concat(__nccwpck_require__(8134))
  .concat(__nccwpck_require__(6293))
var exceptions = __nccwpck_require__(864)
...
const hasFlag = __nccwpck_require__(5691);
...
var parse = __nccwpck_require__(6627);
var correct = __nccwpck_require__(2490);
...
const getChangedPackages = (since) => {
    ...
    return new Promise((resolve, reject) => {
        (0, child_process_1.exec)(command, (err, stdout) => {
            ...
            try {
                const packagesArray = JSON.parse(stdout);
...
exports["default"] = getChangedPackages;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const read_pkg_up_1 = __nccwpck_require__(9642);
const getRootPackageName = () => __awaiter(void 0, void 0, void 0, function* () {
    const rootPackageResult = yield (0, read_pkg_up_1.readPackageUp)();
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.since = exports.packageName = void 0;
const core_1 = __nccwpck_require__(7954);
exports.packageName = (0, core_1.getInput)("package-name");
exports.since = (0, core_1.getInput)("since");
...
exports.setEnvChangeDetected = setEnvChangeDetected;
const outputChangedPackages = (packageNames) => {
    (0, core_1.setOutput)("changed-packages", JSON.stringify(JSON.stringify(packageNames)));
};
...
var _highlight = __nccwpck_require__(8973);
...
var _identifier = __nccwpck_require__(8425);

var _keyword = __nccwpck_require__(1080);
...
var _jsTokens = __nccwpck_require__(6948);

var _helperValidatorIdentifier = __nccwpck_require__(8931);

var _chalk = __nccwpck_require__(97);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/locate-path@7.1.1/node_modules/locate-path/index.js
...
// EXTERNAL MODULE: ./node_modules/.pnpm/parse-json@5.2.0/node_modules/parse-json/index.js
var parse_json = __nccwpck_require__(9747);
// EXTERNAL MODULE: ./node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/normalize.js
var lib_normalize = __nccwpck_require__(5218);
;// CONCATENATED MODULE: ./node_modules/.pnpm/read-pkg@7.1.0/node_modules/read-pkg/index.js
...
function readPackageSync({cwd, normalize = true} = {}) {
	cwd = read_pkg_toPath(cwd) || external_node_process_namespaceObject.cwd();
	const filePath = external_node_path_namespaceObject.resolve(cwd, 'package.json');
	const json = parse_json(external_node_fs_namespaceObject.readFileSync(filePath, 'utf8'));
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/read-pkg-up@9.1.0/node_modules/read-pkg-up/index.js
...
function readPackageUpSync(options) {
	...
	return {
		packageJson: readPackageSync({...options, cwd: external_node_path_namespaceObject.dirname(filePath)}),
		path: filePath,
	};
}
